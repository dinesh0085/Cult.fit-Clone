...
function Care() {
  ...
  return (
    ...
    <Box w={{ base: '100%', md: '95%', lg: '90%' }} m="auto">
        <Text fontSize={{ base: '12px', md: '14px', lg: '18px' }} marginTop="20px" fontWeight={"semibold"} >Lab Tests</Text>
        <Text fontSize={{ base: '8px', md: '10px', lg: '12px' }} color="grey">Assess and monitor your health from the comfort of your home now.</Text> 
...
{/*-------------------- FAQ part -------------------*/}
     ...
     <Box marginTop={"30px"}  bgColor={'#171a26'}>
       
       <Box  w={{ base: '100%', md: '95%', lg: '90%' }} m="auto" >
       
       <Heading color={"white"} >FAQS</Heading>
       <Heading fontSize={{ base: '8px', md: '10px', lg: '12px' }} color={"grey"} marginTop="5px">7 QUESTIONS</Heading>
       
      <Accordion color={"white"} marginTop="20px" defaultIndex={[0]} allowMultiple>
      <AccordionItem>
      <h2>
      <AccordionButton>
